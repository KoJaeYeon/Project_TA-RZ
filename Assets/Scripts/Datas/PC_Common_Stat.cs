public class PC_Common_Stat : Data
{
    ...
    public int Resource_Own_Num { get; set; } = 50;
    ...
    {
        return $"ID: {Id}, Type: {Type}, Attack Power: {Atk_Power}, HP: {HP}, Move Speed: {Move_Speed}, Trash Own Num: {Resource_Own_Num}, Stamina Gain: {Stamina_Gain}, Drain Stamina: {Drain_Stamina}, Dash Stamina: {Dash_Stamina}";
    }
}